...
export default function GuestScreen({ onTrigger, userId }) {
  ...
  const handleConfirm = async () => {
    ...
    setTriggered(true);
    try {
      const result = await onTrigger({ type, location: "Room " + room, floor: parseInt(room.charAt(0)), triggeredBy: userId });
  ...
  return (
    <div style={{
      ...
      <h2 style={{ fontSize: 28, fontWeight: 700, marginBottom: 8, animation: "fadeUp 0.6s ease both" }}>Emergency SOS</h2>
        ...
        <>
          ...
          <div style={{ marginBottom: 40, animation: "fadeUp 0.6s ease 0.3s both" }}>
            ...
            <select value={room} onChange={(e) => setRoom(e.target.value)} style={{
              ...
              padding: "10px 20px", color: "#e8e8f0", fontSize: 14, minWidth: 200, textAlign: "center", outline: "none",
            }}>
        ...
        <div style={{ textAlign: "center", animation: "fadeUp 0.5s ease" }}>
          {isResolved ? (
            <div style={{ animation: "scaleIn 0.4s ease" }}>
              ...
              <p style={{ fontSize: 20, fontWeight: 600, color: "#22c55e", marginBottom: 8 }}>Emergency Resolved</p>
              <p style={{ fontSize: 14, color: "#888" }}>
                Response time:{" "}
                <span style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 700, color: "#22c55e" }}>{myAlert.responseTimeSeconds}s</span>
              </p>
            </div>
          ) : isAck ? (
            <div style={{ animation: "scaleIn 0.4s ease" }}>
              ...
              <p style={{ fontSize: 20, fontWeight: 600, color: "#f59e0b", marginBottom: 8 }}>Help is on the way</p>
            ...
            <div style={{ animation: "scaleIn 0.4s ease" }}>
              ...
              <p style={{ fontSize: 20, fontWeight: 600, color: "#ff2d55", marginBottom: 8 }}>Alert Sent</p>
              <p style={{ fontSize: 13, color: "#888", marginBottom: 16 }}>Notifying hotel staff...</p>
